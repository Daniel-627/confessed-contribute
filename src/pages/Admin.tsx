      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .adm-title {
          ...
          font-size: 28px; color: #f0ece0; margin-bottom: 20px;
        }
        ...
        .adm-tab {
          ...
          color: rgba(240,236,224,0.35); border-bottom: 2px solid transparent;
        ...
        .app-card {
          background: #0b1929; border: 1px solid rgba(255,255,255,0.06);
      ...
      <div className="adm">
        <div className="adm-header">
          ...
          <div className="adm-tabs">
            ...
            <button
              className={`adm-tab${tab === 'emails' ? ' active' : ''}`}
                    ...
                    {articles.map(a => {
                      ...
                      return (
                        <tr key={a.id}>
                          ...
                          <td>
                            {a.status === 'suspended' ? (
                              <button className="btn-reactivate" onClick={() => reinstateArticle(a.id, a.title)}>
                                Reinstate
                              </button>
                            ) : a.status === 'published' ? (
                              <button className="btn-suspend" onClick={() => { setSuspendTarget(a); setSuspendReason('') }}>
                                Suspend
                              </button>
                            ) : null}
                          </td>
